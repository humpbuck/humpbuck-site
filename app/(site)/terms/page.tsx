  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-[1.65] text-ink/85">
        <p>
          This website is operated by HUMPBUCK. Throughout the site, the terms
          “we”, “us” and “our” refer to HUMPBUCK. HUMPBUCK offers this website,
        ...
        <p>
          Our online store is operated through this website and integrated
          payment and fulfillment services that allow us to sell our products
          and Services to you.
        </p>
      </div>
      ...
      <div className="space-y-12 text-sm leading-[1.65] text-ink/85">
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            insult, harm, defame, slander, disparage, intimidate, or discriminate
        ...
        <section>
          ...
          <div className="mt-4 space-y-4">
            ...
            <p>
              In no case shall HUMPBUCK, our directors, officers, employees,
              ...
              for any other claim related in any way to your use of the Service
        ...
        <section>
          ...
          <p className="mt-4">
            You agree to indemnify, defend and hold harmless HUMPBUCK and our
