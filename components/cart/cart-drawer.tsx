        ...
        <div className="border-t border-[color:var(--color-line)] bg-paper px-4 py-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link
              href="/cart"
              onClick={closeCartDrawer}
              className="inline-flex w-full items-center justify-center rounded-2xl border border-[color:var(--color-line)] bg-white/80 px-6 py-3 text-center text-[12px] font-semibold uppercase tracking-[0.12em] text-ink/85 transition hover:border-ink/20"
            >
              View full bag
            </Link>
          </div>
