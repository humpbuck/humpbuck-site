/**
 * Apply scripts/homepage-seo-i18n-batch.json (flat dot paths) into messages/{locale}.json
 * Usage: node scripts/apply-homepage-seo-i18n.mjs [locale...]
 */
import fs from "fs";
...
const patches = JSON.parse(
  fs.readFileSync(path.join(root, "scripts", "homepage-seo-i18n-batch.json"), "utf8")
);
