/**
 * Apply scripts/missing-keys-batch-i18n.json (flat dot paths) into messages/{locale}.json
 * Usage: node scripts/apply-missing-keys-i18n.mjs [locale...]
 */
import fs from "fs";
...
const patches = JSON.parse(
  fs.readFileSync(path.join(root, "scripts", "missing-keys-batch-i18n.json"), "utf8")
);
