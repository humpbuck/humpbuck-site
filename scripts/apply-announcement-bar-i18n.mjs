/**
 * Apply scripts/announcement-bar-i18n-batch.json into messages/{locale}.json
 * Usage: node scripts/apply-announcement-bar-i18n.mjs
 */
...
const patches = JSON.parse(
  fs.readFileSync(path.join(root, "scripts", "announcement-bar-i18n-batch.json"), "utf8"),
);
