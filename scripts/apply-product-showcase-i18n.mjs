/**
 * Apply scripts/product-showcase-i18n-batch.json into messages/{locale}.json
 * Usage: node scripts/apply-product-showcase-i18n.mjs
 */
...
const patches = JSON.parse(
  fs.readFileSync(path.join(root, "scripts", "product-showcase-i18n-batch.json"), "utf8"),
);
