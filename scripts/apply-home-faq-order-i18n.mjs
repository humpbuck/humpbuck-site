/**
 * Apply scripts/home-faq-order-i18n-batch.json into messages/{locale}.json
 * Usage: node scripts/apply-home-faq-order-i18n.mjs
 */
...
const patches = JSON.parse(
  fs.readFileSync(path.join(root, "scripts", "home-faq-order-i18n-batch.json"), "utf8"),
);
